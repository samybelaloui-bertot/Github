...
if("FALSE" STREQUAL "TRUE")
  set(motors_SOURCE_PREFIX /home/samy/catkin_ws/src/motors)
  set(motors_DEVEL_PREFIX /home/samy/catkin_ws/devel)
  set(motors_INSTALL_PREFIX "")
  set(motors_PREFIX ${motors_DEVEL_PREFIX})
else()
  set(motors_SOURCE_PREFIX "")
  set(motors_DEVEL_PREFIX "")
  set(motors_INSTALL_PREFIX /home/samy/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'samy <samy@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samy/catkin_ws/install/${idir}'.  Ask the maintainer 'samy <samy@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${motors_dep}_FOUND)
      find_package(${motors_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${motors_dep} REQUIRED ${depend_list})
  endif()
