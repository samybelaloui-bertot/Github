...
if("FALSE" STREQUAL "TRUE")
  set(detection_SOURCE_PREFIX /home/samy/catkin_ws/src/detection)
  set(detection_DEVEL_PREFIX /home/samy/catkin_ws/devel)
  ...
  set(detection_INSTALL_PREFIX /home/samy/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cyril.colas <cyril.colas@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samy/catkin_ws/install/${idir}'.  Ask the maintainer 'cyril.colas <cyril.colas@todo.todo>' to fix it.")
    endif()
...
set(detection_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${detection_dep}_FOUND)
      find_package(${detection_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${detection_dep} REQUIRED ${depend_list})
  endif()
